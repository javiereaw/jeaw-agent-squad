...
**Disambiguation:**
- "fix" → 💻 developer (general bugs)
- "fix vulnerability/security/OWASP" → 🔒 security-hardener
- "fix slow/performance" → ⚡ performance-optimizer
- "fix test/failing test" → 🧪 test-engineer
