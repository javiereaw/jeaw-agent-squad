...
foreach ($target in $targets) {
    ...
    Write-Host ""
    Write-Host "11 agentes + reglas instalados en $(Split-Path $target -Parent)" -ForegroundColor Green
}
...
Write-Host ""
Write-Host ("=" * 45) -ForegroundColor Cyan
Write-Host "Instalacion completada! (11 agentes + Convergencia)" -ForegroundColor Green
Write-Host ("=" * 45) -ForegroundColor Cyan
Write-Host ""
